...
<div class="bt-box-container bt-product-box-container">
    ...
    <div class="bt-header">
        ...
        <span>
            <select id="bt-product-type" name="bt-product-type">
                <option value="simple" <?php echo esc_attr(selected( $product_object->get_type(), 'simple', false )); ?>><?php _e( 'Simple product', 'bytes_product_frontend' ); ?></option>
                <option value="grouped" <?php echo esc_attr(selected( $product_object->get_type(), 'grouped', false )); ?>><?php _e( 'Grouped product', 'bytes_product_frontend' ); ?></option>
                <option value="external" <?php echo esc_attr(selected( $product_object->get_type(), 'external', false )); ?>><?php _e( 'External/Affiliate product', 'bytes_product_frontend' ); ?></option>
            </select>
            <div id="virtual_downloadable_product">
                <label for="bt-virtual" class="bt-checkbox-label bt-virtual-feature bt-tooltip">
                    ...
                    <input type="checkbox" name="bt-virtual" id="bt-virtual" <?php echo esc_attr($virtual_product); ?>>
                </label>
                <label for="bt-downloadable" class="bt-checkbox-label bt-virtual-feature bt-tooltip">
                    ...
                    <input type="checkbox" name="bt-downloadable" id="bt-downloadable" <?php echo esc_attr($downloadable_product); ?>>
                </label>
            </div>     
        </span>
    </div>
    ...
    <div class="bt-content">
        ...
        <div id="bt-general-product-data" class="bt-option-panel">
            <div class="bt-option-group show_if_external" style="display: none;">
                <p class="form-field _product_url_field">
                    ...
                    <input type="text" class="short bt-input bt-input-inner" name="_product_url" id="_product_url" placeholder="https://" value="<?php echo esc_attr($external_product_url);  ?>">
                ...
                <p class="form-field _button_text_field ">
                    ...
                    <input type="text" class="short bt-input bt-input-inner" name="_button_text" id="_button_text" placeholder="Buy product" value="<?php echo esc_attr($external_button_text); ?>">
            ...
            <div class="bt-option-group show_if_simple show_if_external">
                ...
                <p>
                    ...
                    <input type="text" class="bt-input bt-input-inner" name="regular_price" id="bt-regular-price" placeholder="" value="<?php echo esc_attr($product_object->get_regular_price()); ?>">
                </p>
                <?php } ?>
                ...
                <p>
                    ...
                    <input type="text" class="bt-input bt-input-inner" name="sale_price" id="bt-sale-price" placeholder="" value="<?php echo esc_attr($product_object->get_sale_price()); ?>">
                </p>
                <?php } ?>
            </div>
            <div id="downloadable_product" class="options_group panel woocommerce_options_panel show_if_downloadable" style="display: none;">
                            ...
                            if($downloadable_files){
                                foreach($downloadable_files as $key => $file){ ?>
                                    <tr>
                                        ...
                                        <td class="file_url_choose" width="1%"><a href="#" class="button upload_file_button" data-choose="<?php _e( 'Choose file', 'bytes_product_frontend' ); ?>" data-update="<?php _e( 'Insert file URL', 'bytes_product_frontend' ); ?>"><?php _e( 'Choose file', 'bytes_product_frontend' ); ?></a></td>
                ...
                <p class="form-field _download_limit_field">
                    ...
                    <input type="number" class="short bt-input bt-input-inner" style="" name="_download_limit" id="_download_limit" value="<?php echo esc_attr($product_download_limit); ?>" placeholder="Unlimited" step="1" min="0">
                ...
                <p class="form-field _download_expiry_field ">
                    ...
                    <input type="number" class="short bt-input bt-input-inner" style="" name="_download_expiry" id="_download_expiry" value="<?php echo esc_attr($product_download_expiry); ?>" placeholder="Never" step="1" min="0">
            ...
            <div class="bt-option-group show_if_simple show_if_external show_if_variable">
                <?php
                    ...
                    $taxable = ($product_tax_status) == 'taxable' ? 'selected' : '';
                    $shipping = ($product_tax_status) == 'shipping' ? 'selected' : '';
                    $none = ($product_tax_status) == 'none' ? 'selected' : '';
                ?>
                <p>
                    <label for="bt-tax-status"><?php _e( 'Tax status', 'bytes_product_frontend' );?></label>
                    <select id="bt-tax-status" name="tax_status">
                        <option value="taxable" <?php echo esc_attr($taxable); ?>><?php _e( 'Taxable', 'bytes_product_frontend' ); ?></option>
                        <option value="shipping" <?php echo esc_attr($shipping); ?>><?php _e( 'Shipping only', 'bytes_product_frontend' ); ?></option>
                        <option value="none" <?php echo esc_attr($none); ?>><?php _e( 'None', 'bytes_product_frontend' ); ?></option>
                    </select>
                    <?php
                    ...
                    <select id="bt-tax-class" name="tax_class">
                        <?php
                            foreach($tax_classes as $key => $value){
                                $tax_class_selection = ($product_tax_class == $key) ? 'selected' : '';
                                echo '<option value="'. esc_attr( $key ).'"' . esc_attr( $tax_class_selection ) . '>'. esc_html( $value, 'bytes_product_frontend' ) .'</option>';
                            }
                        ?>	
                    </select>
                    <?php
        ...
        <div id="bt-inventory-product-data" class="bt-option-panel bt-hide-section">
            <div class="bt-option-group">
                ...
                <p>
                    ...
                    <input type="text" class="bt-input bt-input-inner" name="sku" id="bt-sku" placeholder="" value="<?php echo esc_attr($product_object->get_sku()); ?>">
                    <?php
                ...
                <p class="show_if_simple show_if_variable">
                    ...
                    <input type="checkbox" class="bt-input product_manage_stock" name="manage_stock" id="bt-manage-stock" <?php echo esc_html($product_manage_stock, 'bytes_product_frontend'); ?>>
                </p>
                <?php } ?>
                <div class="bt-manage-stock-section bt-hide-section">
                    ...
                    <p>
                        ...
                        <input type="number" class="bt-input bt-input-inner" name="bt_stock" id="bt-stock" value="<?php echo esc_attr($product_object->get_stock_quantity()); ?>">
                        <?php
                    ...
                    <p>
                        <?php
                        $product_backorders_no = ($product_backorders == "no") ? "selected" : "";
                        $product_backorders_notify = ($product_backorders == "notify") ? "selected" : "";
                        $product_backorders_yes = ($product_backorders == "yes") ? "selected" : "";
                        ?>
                        ...
                        <select class="bt-input bt-input-inner" name="bt_backorders" id="bt-backorders">
                            <option value="no" <?php echo esc_attr($product_backorders_no); ?>><?php _e( 'Do not allow', 'bytes_product_frontend' ); ?></option>
                            <option value="notify" <?php echo esc_attr($product_backorders_notify); ?>><?php _e( 'Allow, but notify customer', 'bytes_product_frontend' ); ?></option>
                            <option value="yes" <?php echo esc_attr($product_backorders_yes); ?>><?php _e( 'Allow', 'bytes_product_frontend' ); ?></option>
                        </select>
                        <?php
                    ...
                    <p>
                        ...
                        <input type="number" class="bt-input bt-input-inner" name="bt_low_stock_amount" id="bt-low-stock-amount" value="<?php echo esc_attr($product_object->get_low_stock_amount()); ?>">
                        <?php
                    ...
                    <select id="bt-stock-status" name="stock_status">
                        <?php
                            foreach ($stock_status_options as $key => $value) {
                                $stock_status_selection = ($product_stock_status == $key) ? "selected" : "";
                                echo '<option value="'. esc_attr( $key ).'" '. esc_attr( $stock_status_selection ).'>'. esc_html( $value, 'bytes_product_frontend' ) .'</option>';
                            }
                        ?>
                    </select>
                    <?php
            ...
            <div class="bt-option-group show_if_simple show_if_variable">
                <p>
                    ...
                    <input type="checkbox" class="bt-input" name="sold_individually" id="bt-sold-individually" <?php echo esc_attr($product_sold_individually); ?>>
        ...
        <div id="bt-shipping-product-data" class="bt-option-panel bt-hide-section">
            <div class="bt-option-group">
                ...
                <p>
                    ...
                    <input type="text" class="bt-input bt-input-inner" name="weight" id="bt-weight" placeholder="0" value="<?php echo esc_attr($product_object->get_weight()); ?>">
                    <?php
                ...
                <p class="bt-dimensions-field">
                    ...
                    <span>
                        <input type="text" class="bt-input bt-input-inner" name="length" id="bt-product-length" placeholder="Length" style="" value="<?php echo esc_attr($product_object->get_length()); ?>">
                        <input type="text" class="bt-input bt-input-inner" name="width" placeholder="Width" value="<?php echo esc_attr($product_object->get_width()); ?>">
                        <input type="text" class="bt-input bt-input-inner" name="height" placeholder="Height" value="<?php echo esc_attr($product_object->get_height()); ?>">
                    </span>
                    <?php
            ...
            <div class="bt-option-group">
                <p>
                    ...
                    <select id="bt-shipping-class" name="shipping_class">
                        <option value="-1" selected="selected"><?php _e( 'No shipping class', 'bytes_product_frontend' ); ?></option>
                        <?php
                            foreach ($shipping_classes as $shipping_class) {
                                $product_shipping_class_id = ($product_object->get_shipping_class_id() == $shipping_class->term_id) ? "selected" : "";   
                                echo '<option value="'. esc_attr( $shipping_class->term_id ) .'" ' . esc_attr( $product_shipping_class_id ) . '>'.esc_html($shipping_class->name, 'bytes_product_frontend').'</option>';
                            }
                        ?>
                    </select>
                    <?php
            ...
            <div class="bt-option-group">
                ...
                <p class="form-field show_if_grouped">
                    ...
                    <select class="wc-product-search" multiple="multiple" style="width: 50%;" id="grouped_products" name="grouped_products[]" data-sortable="true" data-placeholder="<?php esc_attr_e( 'Search for a product&hellip;' ); ?>">
                        ...
                        foreach ( $linked_products as $product ) {
                            $grouped_product_selection = (in_array($product->get_id(), $grouped_product_ids)) ? "selected" : "";
                            $product = wc_get_product($product->get_id());
                            if ( is_object( $product ) ) {
                                echo '<option value="' . esc_attr( $product->get_id() ) . '" '. $grouped_product_selection .'>' . esc_html( wp_strip_all_tags( $product->get_formatted_name() ) ) . '</option>';
                            }
                        }
                        ?>
                    </select> 
                ...
                <p class="form-field">
                    ...
                    <select class="wc-product-search" multiple="multiple" style="width: 50%;" id="upsell_ids" name="upsell_ids[]" data-placeholder="<?php esc_attr_e( 'Search for a product&hellip;' ); ?>">
                        <?php
                        foreach ( $linked_products as $product ) {
                            $upsell_selection = in_array($product->get_id(), $product_object->get_upsell_ids()) ? "selected" : "";
                            $product = wc_get_product( $product->get_id() );
                            if ( is_object( $product ) ) {
                                echo '<option value="' . esc_attr( $product->get_id() ) . '" '.$upsell_selection.'>' . esc_html( wp_strip_all_tags( $product->get_formatted_name() ) ) . '</option>';
                            }
                        }
                        ?>
                    </select> 
                ...
                <p class="form-field hide_if_grouped hide_if_external">
                    ...
                    <select class="wc-product-search" multiple="multiple" style="width: 50%;" id="crosssell_ids" name="crosssell_ids[]" data-placeholder="<?php esc_attr_e( 'Search for a product&hellip;' ); ?>">
                        <?php
                        foreach ( $linked_products as $product ) {
                            $cross_sell_selection = in_array($product->get_id(), $product_object->get_cross_sell_ids()) ? "selected" : "";
                            $product = wc_get_product( $product->get_id() );
                            if ( is_object( $product ) ) {
                                echo '<option value="' . esc_attr( $product->get_id() ) . '" '.$cross_sell_selection.'>' . esc_html( wp_strip_all_tags( $product->get_formatted_name() ) ) . '</option>';
                            }
                        }
                        ?>
                    </select> 
        ...
        <div id="bt-attributes-product-data" class="bt-option-panel bt-hide-section">
            ...
            <?php
                require_once( plugin_dir_path( __FILE__ ).'bytes-woo-template-product-attributes.php');
            ?>
        </div>
        <!-- Advanced -->
        <div id="bt-advanced-product-data" class="bt-option-panel bt-hide-section">
            ...
            <div class="bt-option-group hide_if_external hide_if_grouped">
                ...
                <p>
                    ...
                    <textarea class="bt-input bt-input-inner" name="purchase_note" id="bt-purchase-note" placeholder="" rows="2" cols="20"><?php echo esc_html($product_object->get_purchase_note(), 'bytes_product_frontend'); ?></textarea>
                    <?php
            ...
            <div class="bt-option-group">
                ...
                <p>
                    ...
                    <input type="number" class="bt-input bt-input-inner" name="menu_order" id="bt-menu-order" placeholder="" value="<?php echo esc_attr($product_object->get_menu_order()); ?>" step="1">
                    <?php
            ...
            <div class="bt-option-group">
                <p>
                    ...
                    <input type="checkbox" class="bt-input" name="reviews_allowed" id="bt-reviews-allowed" <?php echo esc_attr($product_reviews_allowed); ?>>     
                </p>      
            </div>
            <?php } ?>
        </div>  
