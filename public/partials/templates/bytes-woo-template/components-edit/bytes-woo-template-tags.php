...
?>
<!-- Product tags -->
<div class="bt-box-container bt-product-box-container edit-product-tag">
    <div class="bt-header">
        <h2><?php _e( 'Product tags', 'bytes_product_frontend' ); ?></h2>
    </div>
    <div class="bt-content bt-content-tags" style="padding: 12px;">
        <input type="text" id="bt-input-values" list="bt-tags" class="bt-input" name="tags" placeholder="" style="width: auto;" value="<?php echo esc_attr($edit_product_tags); ?>">
        <datalist id="bt-tags">
        <?php
