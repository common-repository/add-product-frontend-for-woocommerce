...
?>
<!-- Product image -->
<div class="bt-box-container bt-product-box-container edit-product-featured-image">
    <div class="bt-header">
        <h2><?php _e( 'Product image', 'bytes_product_frontend' ); ?></h2>
    </div>
    <div class="bt-content bt-content-image" style="padding: 12px;">
        <input value="<?php echo esc_attr($product_object->get_image_id()); ?>" name="bt_product_image" type="hidden" />
        <img src="<?php echo esc_url(wp_get_attachment_url($product_object->get_image_id())); ?>" class="bt-product-image bt-hide-section" width="213" height="200">
